...
c=new d,c.addTo(a.map())}return b.redraw()},b.redraw=function(){return c._update(),b},b.leafletLegend=function(){return c},b.position=function(a){return arguments.length?(d=a,b):d},b},function(){"use strict";var a=require("topojson");L.TopoJSON=L.GeoJSON.extend({addData:function(b){if("Topology"===b.type)for(var c in b.objects){var d=a.feature(b,b.objects[c]);L.GeoJSON.prototype.addData.call(this,d)}else L.GeoJSON.prototype.addData.call(this,b)}})}(),function(){"use strict";return!dc.baseGoogleChart&&void(dc.baseGoogleChart=function(a){return a=dc.baseMapChart(a),a._doRender=function(){var b=new google.maps.Map(a.root().node(),a.mapOptions());return a.center()&&a.zoom()&&(b.setCenter(a.toLocArray(a.center())),b.setZoom(a.zoom())),a.map(b),a._postRender(),a._doRedraw()},a.toLocArray=function(a){
// else expects [11.111,1.111]
// expects '11.111,1.111'
...
// data
"cap","ordering","dimension","group","othersGrouper","data"],p=0;p<o.length;p++)c(o[p]);var q=["_doRedraw","redraw","_doRender","render","calculateColorDomain","filterAll","resetSvg","expireCache"];for(p=0;p<q.length;p++)d(q[p]);return e.anchor(a,b)})}(),function(){"use strict";return!dc.paginationMixin&&void(dc.paginationMixin=function(a){
