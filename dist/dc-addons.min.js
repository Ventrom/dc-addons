...
return"string"==typeof a&&(a=a.split(",")),a},a})}(),function(){"use strict";return!dc.leafletChoroplethChart&&void(dc.leafletChoroplethChart=function(a,b){var c=dc.colorChart(dc.baseLeafletChart({})),d=!1,e=[],f=!1,g={fillColor:"black",color:"gray",opacity:.4,fillOpacity:.6,weight:1},h=function(a){return a.key},i=function(a){var b=e[c.featureKeyAccessor()(a)],d=c.featureOptions(),f=d instanceof Function;return f&&(d=d(a,b)),d=JSON.parse(JSON.stringify(d)),b&&b.d&&!f&&(d.fillColor=c.getColor(b.d,b.i),c.filters().indexOf(b.d.key)!==-1&&(d.opacity=.8,d.fillOpacity=1)),d};c._postRender=function(){d=L.geoJson(c.geojson(),{style:c.featureStyle(),onEachFeature:j}),c.map().addLayer(d)},c._doRedraw=function(){d.clearLayers(),e=[],c._computeOrderedGroups(c.data()).forEach(function(a,b){e[c.keyAccessor()(a)]={d:a,i:b}}),d.addData(c.geojson())},c.geojson=function(a){return arguments.length?(f=a,c):f},c.featureOptions=function(a){return arguments.length?(g=a,c):g},c.featureKeyAccessor=function(a){return arguments.length?(h=a,c):h},c.featureStyle=function(a){return arguments.length?(i=a,c):i};var j=function(a,b){var d=e[c.featureKeyAccessor()(a)];d&&d.d&&(b.key=d.d.key,c.renderPopup()&&b.bindPopup(c.popup()(d.d,a)),c.brushOn()&&b.on("click",k))},k=function(a){if(a.target){var b=a.target.key;dc.events.trigger(function(){c.filter(b),dc.redrawAll(c.chartGroup())})}};return c.anchor(a,b)})}(),function(){"use strict";return!dc.leafletMarkerChart&&void(dc.leafletMarkerChart=function(a,b){var c=dc.baseLeafletChart({}),d=!1,e=!1,f=!1,g=!0,h=!1,i=!1,j=!1,k=!1,l=!1,m={},n=!0,o=!1,p=!1,q=!0,r=!1;c.renderTitle(!0);var s=function(a){return c.keyAccessor()(a)},t=function(a){var b=new L.Marker(c.toLocArray(c.locationAccessor()(a)),{title:c.renderTitle()?c.title()(a):"",alt:c.renderTitle()?c.title()(a):"",icon:u(a,c.map()),clickable:c.renderPopup()||c.brushOn()&&!h,draggable:!1});return b},u=function(a,b){return new L.Icon.Default},v=function(a,b){return c.title()(a)};c._postRender=function(){if(c.brushOn()&&(h&&c.filterHandler(z),c.map().on("zoomend moveend",y,this),h||c.map().on("click",y,this),c.map().on("zoomstart",x,this)),l=d?new L.MarkerClusterGroup(e?e:null):new L.LayerGroup,c.map().addLayer(l),i){var a=L.Control.extend({options:{position:"topleft"},onAdd:function(a){var b=L.DomUtil.create("div","leaflet-bar leaflet-control leaflet-control-filter");return h||L.DomUtil.addClass(b,"disabled"),b.onclick=function(){h=!h,h?(L.DomUtil.removeClass(b,"disabled"),c.filter(null),j=!0,c.filter(c.map().getBounds()),j=!1):(L.DomUtil.addClass(b,"disabled"),c.filter(null)),dc.redrawAll(c.chartGroup())},b}});c.map().addControl(new a)}},c._doRedraw=function(){var a=c._computeOrderedGroups(c.data()).filter(function(a){return 0!==c.valueAccessor()(a)});f&&(m={}),l.clearLayers();var b=[];if(a.forEach(function(a,d){var e=c.keyAccessor()(a),g=null;g=!f&&e in m?m[e]:w(a,e);var h=c.filters(),i=h.length?.3:1;h.forEach(function(a){e===a&&(i=1)}),g.setOpacity(i),c.cluster()?b.push(g):l.addLayer(g)}),c.cluster()&&b.length>0&&l.addLayers(b),b.length>0&&(n||o&&!p)){var d=new L.featureGroup(b);c.map().fitBounds(d.getBounds())}p=!1,n=!1},c.locationAccessor=function(a){return arguments.length?(s=a,c):s},c.marker=function(a){return arguments.length?(t=a,c):t},c.icon=function(a){return arguments.length?(u=a,c):u},c.popup=function(a){return arguments.length?(v=a,c):v},c.renderPopup=function(a){return arguments.length?(q=a,c):q},c.popupOnHover=function(a){return arguments.length?(r=a,c):r},c.cluster=function(a){return arguments.length?(d=a,c):d},c.clusterOptions=function(a){return arguments.length?(e=a,c):e},c.rebuildMarkers=function(a){return arguments.length?(f=a,c):f},c.brushOn=function(a){return arguments.length?(g=a,c):g},c.filterByArea=function(a){return arguments.length?(h=a,c):h},c.filterByAreaControl=function(a){return arguments.length?(i=a,c):i},c.fitOnRender=function(a){return arguments.length?(n=a,c):n},c.fitOnRedraw=function(a){return arguments.length?(o=a,c):o},c.markerGroup=function(){return l};var w=function(a,b){var d=t(a);return d.key=b,c.renderPopup()&&(d.bindPopup(c.popup()(a,d)),c.popupOnHover()&&(d.on("mouseover",function(){d.openPopup()}),d.on("mouseout",function(){d.closePopup()}))),c.brushOn()&&!h&&d.on("click",A),m[b]=d,d},x=function(a){k=!0},y=function(a){if("moveend"!==a.type||!k&&!a.hard)if(k=!1,p=!0,h){var b;b=c.map().getCenter().equals(c.center())&&c.map().getZoom()===c.zoom()?null:c.map().getBounds(),dc.events.trigger(function(){c.filter(null),b&&(j=!0,c.filter(b),j=!1),dc.redrawAll(c.chartGroup())})}else c.filter()&&("click"===a.type||m.hasOwnProperty(c.filter())&&!c.map().getBounds().contains(m[c.filter()].getLatLng()))&&dc.events.trigger(function(){c.filter(null),q&&c.map().closePopup(),dc.redrawAll(c.chartGroup())})},z=function(a,b){p=!0,c.dimension().filter(null),b&&b.length>0&&(c.dimension().filterFunction(function(a){if(!(a in m))return!1;var c=m[a].getLatLng();return c&&b[0].contains(c)}),j||c.map().getBounds().toString===b[0].toString()||c.map().fitBounds(b[0]))},A=function(a){if(a.target){p=!0;var b=a.target.key;dc.events.trigger(function(){c.filter(b),dc.redrawAll(c.chartGroup())})}};return c.anchor(a,b)})}(),function(){"use strict";return!dc.leafletCustomChart&&void(dc.leafletCustomChart=function(a,b){var c=dc.baseLeafletChart({}),d=null,e=null;return c.renderTitle(!0),c._postRender=function(){var a=c._computeOrderedGroups(c.data());a.forEach(function(a,b){c.renderItem()(c,c.map(),a,b)})},c._doRedraw=function(){var a=c._computeOrderedGroups(c.data()),b=c.valueAccessor();a.forEach(function(a,d){a.filtered=0===b(a),c.redrawItem()(c,c.map(),a,d)})},c.redrawItem=function(a){return arguments.length?(d=a,c):d},c.renderItem=function(a){return arguments.length?(e=a,c):e},c.anchor(a,b)})}(),
...
// data
"cap","ordering","dimension","group","othersGrouper","data"],p=0;p<o.length;p++)c(o[p]);var q=["_doRedraw","redraw","_doRender","render","calculateColorDomain","filterAll","resetSvg","expireCache"];for(p=0;p<q.length;p++)d(q[p]);return e.anchor(a,b)})}(),function(){"use strict";return!dc.serverChart&&("dc"in window||(window.dc={}),void(dc.serverChart=function(a){
//---------------------
// Browser Events
//---------------------
function b(){r.selectAll(C).each(function(a,b){var c=d3.select(this),d=m(c);"function"==typeof dc.serverChart["attachEvents"+d]&&dc.serverChart["attachEvents"+d](b,c)})}function c(a,b){if(b.select("g.brush").size()>0){var c=b.select("g.brush").select(".background").attr("width");b.select("g.brush").on("mousedown",function(){u=d3.mouse(this),y=w,x=v}).on("mousemove",function(){if(null!==u){var a=d3.mouse(this),b=d3.select(this),d=null;if(z){var e=a[0]-u[0];w=y+e,v=x+e,w<0&&(w=0,v=x-y),v>c&&(v=c,w=c-(x-y))}else A?(w=w,v=a[0],v<w&&(d=w,w=v,v=d,A=!1,B=!0),w<0&&(w=0),v>c&&(v=c)):B?(w=a[0],v=v,v<w&&(d=w,w=v,v=d,A=!0,B=!1),w<0&&(w=0),v>c&&(v=c)):(w=d3.min([a[0],u[0]]),v=d3.max([a[0],u[0]]),w<0&&(w=0),v>c&&(v=c));b.select(".extent").attr("x",w).attr("width",v-w),b.selectAll("g.resize").style("display","inline"),b.select("g.resize.e").attr("transform","translate("+v+", 0)"),b.select("g.resize.w").attr("transform","translate("+w+", 0)")}}).on("mouseup",function(){var b=d3.mouse(this),c=d3.select(this);null===u||b[0]===u[0]?(c.select(".extent").attr("width",0),c.selectAll("g.resize").style("display","none"),d(a,[null,null])):
...
// Helper Functions
//---------------------
function k(){r.html(s.loadingMessage)}function l(){o=io(s.server,{reconnectionDelay:500,reconnectionDelayMax:2e3,reconnectionAttempts:4}),
// socket events
o.io.on("open",function(){q=!0}),o.io.on("reconnecting",function(){q||r.html(s.reconnectingMessage)}),o.io.on("reconnect_failed",function(){q||r.html(s.connectionErrorMessage)}),
// custom events
o.on("preRender",f),o.on("afterRender",g),o.on("afterRenderError",h),o.on("afterFilter",i),o.on("afterFilterError",h),p=!0}function m(a){try{var b=a.attr("data-type").split("");return b[0]=b[0].toUpperCase(),b.join("")}catch(a){return null}}var n={},o=null,p=!1,q=!1,r=d3.select(a),s={name:null,server:"http://127.0.0.1:3000/",errorMessage:"A problem occurred creating the charts. Please try again later",loadingMessage:"Loading",reconnectingMessage:"There appears to be a problem connecting to the server. Retyring...",connectionErrorMessage:"Could not connect to the server."},t=null,u=null,v=null,w=null,x=null,y=null,z=!1,A=!1,B=!1,C=".dc-server-chart";
//---------------------
// Chart Events
//---------------------
//---------------------
