...
c=new d,c.addTo(a.map())}return b.redraw()},b.redraw=function(){return c._update(),b},b.leafletLegend=function(){return c},b.position=function(a){return arguments.length?(d=a,b):d},b},function(){"use strict";var a=require("topojson");L.TopoJSON=L.GeoJSON.extend({addData:function(b){if("Topology"===b.type)for(var c in b.objects){var d=a.feature(b,b.objects[c]);L.GeoJSON.prototype.addData.call(this,d)}else L.GeoJSON.prototype.addData.call(this,b)}})}();